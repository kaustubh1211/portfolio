      ...
      <Container>
        <div className="space-y-10">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">Showcasing my work across web development and full-stack solutions</p>
          </div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          <h4 className="font-semibold text-base text-gray-900 dark:text-white">{project.name}</h4>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">{project.tagline}</p>
                      </div>
                    ...
                    {!isExpanded && (
                      <div className="flex flex-wrap items-center gap-1.5 mt-3">
                        {project.techStack.slice(0, 4).map((tech, idx) => (
                          <div key={idx} className="px-2 py-1 bg-gray-200 dark:bg-gray-900/50 rounded text-[11px] text-gray-700 dark:text-gray-400 border border-gray-300 dark:border-gray-800">
                            {tech}
                          </div>
                        ))}
                        {project.techStack.length > 4 && (
                          <span className="text-[11px] text-gray-500 dark:text-gray-500">+{project.techStack.length - 4}</span>
                        )}
                      </div>
                    )}
                  </button>
                  ...
                  >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          {project.techStack.map((tech, idx) => (
                            <div key={idx} className="px-2.5 py-1.5 bg-gray-200 dark:bg-gray-900/50 rounded-lg text-xs text-gray-800 dark:text-gray-300 border border-gray-300 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-700 transition-colors">
                              {tech}
                            </div>
                          ))}
                        </div>
                    ...
                    <a
                            ...
                            className="flex items-center gap-2 px-3 py-2 bg-gray-200 dark:bg-gray-800/50 hover:bg-gray-300 dark:hover:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-sm text-gray-800 dark:text-gray-300 transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-600"
                          >
                        ...
                        {project.liveUrl && (
                          <a
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-500/10 hover:bg-blue-100 dark:hover:bg-blue-500/20 border border-blue-200 dark:border-blue-500/20 rounded-lg text-sm text-blue-600 dark:text-blue-400 transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-500/40"
                          >
