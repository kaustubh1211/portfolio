...
const GitHubActivity = () => {
  ...
  return (
    <section className="bg-white dark:bg-black text-gray-900 dark:text-white transition-colors py-16">
      <Container>
        <motion.div
        ...
        >
          ...
          <div className="border border-gray-200 dark:border-gray-800 rounded-xl p-6 md:overflow-hidden overflow-x-auto relative bg-gray-50 dark:bg-gray-900/50">
            {loading ? (
              ...
              <div className="min-w-[700px]">
                ...
                <div className="flex gap-1">
                  {/* Day Labels */}
                  <div className="flex flex-col gap-1 text-xs text-gray-500 dark:text-gray-500 pr-2">
                      ...
                      <div key={weekIndex} className="flex flex-col gap-1">
                        {week.map((day, dayIndex) => (
                          <div
                            ...
                            className="cursor-pointer transition-all hover:ring-2 hover:ring-gray-400 dark:hover:ring-white/50 rounded-sm"
                            style={{
                              width: '8px',
                              height: '9px',
            ...
            <div className="flex items-center justify-end gap-2 mt-6 text-xs text-gray-500 dark:text-gray-500">
              ...
              <div className="flex gap-1.5">
                <div className="w-3 h-3 bg-[#ebedf0] dark:bg-gray-800 rounded-sm"></div>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-600 transition-all text-sm group text-gray-900 dark:text-white"
          >
